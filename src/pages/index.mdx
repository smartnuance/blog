...
<Services>
<Service title="Learn programming (Coming soon)" icon="user-graduate">
...
<Services>
<Service title="API-centric architecture" icon="shapes">
...
- using tutorial style docs and videos to provide a seemless onboarding experience for new team joiners
